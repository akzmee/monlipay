      ...
      <div className="mx-auto max-w-4xl px-4 py-20 sm:py-28">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            {!isContractDeployed ? (
              ...
              <Link
                href="/create"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-600 to-orange-500 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-red-500/20 transition-all hover:from-red-500 hover:to-orange-400 hover:shadow-red-500/30 active:scale-95 sm:w-auto"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
        ...
        <div className="mt-20 grid gap-6 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-stone-200 bg-white/70 p-6 backdrop-blur transition-shadow hover:shadow-md dark:border-stone-800 dark:bg-stone-900/70">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-red-100 text-red-600 dark:bg-red-950/40 dark:text-red-400">
          ...
          {/* Feature 2 */}
          <div className="rounded-2xl border border-stone-200 bg-white/70 p-6 backdrop-blur transition-shadow hover:shadow-md dark:border-stone-800 dark:bg-stone-900/70">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-orange-100 text-orange-600 dark:bg-orange-950/40 dark:text-orange-400">
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="mt-20">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-red-600 text-sm font-bold text-white">
                1
              </div>
            ...
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-orange-500 text-sm font-bold text-white">
                2
              </div>
              <h4 className="mb-1 font-semibold text-stone-900 dark:text-stone-100">
                Share it anywhere
        ...
        <div className="mt-20 text-center">
          <Link
            href="/create"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-600 to-orange-500 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-red-500/20 transition-all hover:from-red-500 hover:to-orange-400 hover:shadow-red-500/30 active:scale-95"
          >
            Get started
